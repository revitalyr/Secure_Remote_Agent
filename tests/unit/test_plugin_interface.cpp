...
public:
    ...
    QString getLastError() const override { return lastError; }
    ...
    bool registerCommand(const CommandDescriptor& descriptor) override {
    ...
    QVariantMap executeCommand(const QString& commandName, const QVariantMap& params) override {
    ...
    QStringList getRegisteredCommands() const override {
        return m_commands.keys();
    }

    CommandDescriptor getCommandDescriptor(const QString& commandName) const override {
...
private:
    ...
    QMap<QString, CommandDescriptor> m_commands;
};
